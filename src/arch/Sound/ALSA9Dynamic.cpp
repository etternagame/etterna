...
LoadALSA()
{
	 ...
	 * versions of ALSA lying around; we're likely to crash if we go near it.
	 * Do this first, before loading the ALSA library, since making any ALSA
	 * calls may load ALSA core modules.
	 *
