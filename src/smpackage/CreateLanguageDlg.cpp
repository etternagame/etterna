...
void
CreateLanguageDlg::DoDataExchange(CDataExchange* pDX)
{
...
static const char* const g_aListedLanguageCodes[] = {
	"ab", "af", "ar", "az", "be", "bg", "ca", "cs", "cy", "da", "de", "el",
	"en", "es", "et", "eu", "fa", "fi", "fr", "ga", "gl", "ha", "he", "hi",
	"hr", "hu", "hy", "id", "in", "is", "it", "iw", "ja", "kk", "kn", "ko",
	"ky", "lt", "lv", "mk", "ms", "mt", "nl", "no", "pl", "ps", "pt", "rn",
	"ro", "ru", "rw", "sk", "sl", "so", "sq", "sr", "sv", "sw", "te", "th",
	"tr", "uk", "ur", "uz", "vi", "wo", "xh", "yo", "zh", "zu",
};

BOOL
CreateLanguageDlg::OnInitDialog()
{
	...
	for (int i = 0; i < ARRAYLEN(g_aListedLanguageCodes); ++i) {
		RString s =
		  SMPackageUtil::GetLanguageDisplayString(g_aListedLanguageCodes[i]);
...
void
CreateLanguageDlg::OnBnClickedOk()
{
