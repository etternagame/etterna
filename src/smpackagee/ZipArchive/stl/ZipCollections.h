...
#pragma warning(disable : 4284) // return type for 'identifier::operator >' is
								// not a UDT or reference to a UDT. Will produce
								// errors if applied using infix notation
...
#ifndef _MSC_VER
	TYPE& operator[](int iIndex) { return inherited::operator[](iIndex); }
...
class ZIP_API CZipMap : private std::map<KEY, VALUE>
{
  public:
	...
	BOOL RemoveKey(KEY key) { return erase(key) != 0; }
