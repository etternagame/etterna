...
------------------------------------------------------*/
int
CCmdLine::SplitLine(int argc, char** argv)
{
	clear();
...
bool
CCmdLine::IsSwitch(const char* pParam)
{
	if (pParam == NULL)
		return false;
...
bool
CCmdLine::HasSwitch(const char* pSwitch)
{
	CCmdLine::iterator theIterator;
...
/*
   ...
   StringType CCmdLine::GetSafeArgument(const char *pSwitch, int iIdx, const
char *pDefault)
...
StringType
CCmdLine::GetSafeArgument(const char* pSwitch, int iIdx, const char* pDefault)
{
	StringType sRet;
...
StringType
CCmdLine::GetArgument(const char* pSwitch, int iIdx)
{
...
int
CCmdLine::GetArgumentCount(const char* pSwitch)
{
