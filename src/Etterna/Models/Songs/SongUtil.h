...
void
SortSongPointerArrayByWifeScore(std::vector<Song*>& v);
void
...
void
SortSongPointerArrayByStepAuthor(std::vector<Song*>& vpSongsInOut);
...
void
GetAllSongGenres(std::vector<std::string>& vsOut);
void
GetPlayableStepsTypes(const Song* pSong, std::set<StepsType>& vOut);
void
GetPlayableSteps(const Song* pSong, std::vector<Steps*>& vOut, bool filteringSteps = false);
auto
