...
bool CheckVideoDefaultSettings() {
    ...
    Locator::getLogger()->info("Last seen video driver: {}", PREFSMAN->m_sLastSeenVideoDriver.Get().c_str());
...
namespace StepMania {
	...
	Locator::getLogger()->info("Logging level {} (0 - TRACE | 5 - FATAL)", PREFSMAN->m_logging_level.Get());
