...
void
PlayerSpectate::Init(const std::string& sType,
...
void
PlayerSpectate::UpdateHoldNotes(int iSongRow,
							  float fDeltaTime,
...
void
PlayerSpectate::UpdateHoldsAndRolls(
  float fDeltaTime,
...
void
PlayerSpectate::Update(float fDeltaTime)
{
...
void
PlayerSpectate::SetPlaybackEvents(std::map<int, std::vector<PlaybackEvent>> v,
								bool dontclear)
{
	if (!dontclear) {
...
void
PlayerSpectate::CheckForSteps(const std::chrono::steady_clock::time_point& tm)
{
...
void
PlayerSpectate::UpdatePressedFlags()
{
	const auto iNumCols =
...
void
PlayerSpectate::CrossedRows(int iLastRowCrossed,
						  const std::chrono::steady_clock::time_point& now)
{
...
void
PlayerSpectate::HandleTapRowScore(unsigned row)
{
...
void
PlayerSpectate::UpdateTapNotesMissedOlderThan(float fMissIfOlderThanSeconds)
{
...
// (same as PlayerReplay here)
void
PlayerSpectate::Step(int col,
				   int steppedRow,
