...
GameManager::GameManager()
{
	...
	m_vTurnsToReset;
	m_iPreviousFail =
	  FailType_Immediate; // this should never get called without being set with
						  // the player's existing option but default to avoid
						  // crashing due to a malformed enum just in case
