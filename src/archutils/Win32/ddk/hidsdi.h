...
BOOLEAN __stdcall HidD_FreePreparsedData(IN PHIDP_PREPARSED_DATA PreparsedData);

BOOLEAN __stdcall HidD_FlushQueue(IN HANDLE HidDeviceObject);
/*
Routine Description:
...
BOOLEAN __stdcall HidD_GetConfiguration(IN HANDLE HidDeviceObject,
...
BOOLEAN __stdcall HidD_SetConfiguration(IN HANDLE HidDeviceObject,
...
Arguments:
	HidDeviceObject      A handle to a Hid Device Object.
		Configuration        A configuration structure.  HidD_GetConfiguration
MUST be called before the configuration can be modified and set using
HidD_SetConfiguration ConfigurationLength  That is ``sizeof
(HIDD_CONFIGURATION)''. Using this parameter, we can later increase the length
of the configuration array and not break older apps. Return Value: TRUE if
successful FALSE otherwise  -- Use GetLastError() to get extended error
information
*/

BOOLEAN __stdcall HidD_GetFeature(IN HANDLE HidDeviceObject,
...
BOOLEAN __stdcall HidD_SetFeature(IN HANDLE HidDeviceObject,
...
BOOLEAN __stdcall HidD_GetNumInputBuffers(IN HANDLE HidDeviceObject,
...
BOOLEAN __stdcall HidD_SetNumInputBuffers(IN HANDLE HidDeviceObject,
...
BOOLEAN __stdcall HidD_GetPhysicalDescriptor(IN HANDLE HidDeviceObject,
											 OUT PVOID Buffer,
...
BOOLEAN __stdcall HidD_GetManufacturerString(IN HANDLE HidDeviceObject,
											 OUT PVOID Buffer,
											 IN ULONG BufferLength);
/*
Routine Description:
...
BOOLEAN __stdcall HidD_GetProductString(IN HANDLE HidDeviceObject,
										OUT PVOID Buffer,
										IN ULONG BufferLength);
/*
Routine Description:
...
BOOLEAN __stdcall HidD_GetIndexedString(IN HANDLE HidDeviceObject,
...
BOOLEAN __stdcall HidD_GetSerialNumberString(IN HANDLE HidDeviceObject,
											 OUT PVOID Buffer,
											 IN ULONG BufferLength);
/*
Routine Description:
