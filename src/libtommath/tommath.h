...
typedef int
ltm_prime_callback(unsigned char* dst, int len, void* dat);
...
int
mp_init_set_int(mp_int* a, unsigned long b);
...
int
mp_exteuclid(mp_int* a, mp_int* b, mp_int* U1, mp_int* U2, mp_int* U3);
 ...
 */
int
mp_reduce(mp_int* a, mp_int* b, mp_int* c);
...
/* d = a**b (mod c) */
int
mp_exptmod(mp_int* a, mp_int* b, mp_int* c, mp_int* d);
 ...
 */
int
mp_prime_rabin_miller_trials(int size);
 ...
 */
int
mp_prime_next_prime(mp_int* a, int t, int bbs_style);
 ...
 * LTM_PRIME_BBS) LTM_PRIME_2MSB_OFF - make the 2nd highest bit zero
...
int
mp_to_unsigned_bin_n(mp_int* a, unsigned char* b, unsigned long* outlen);

int
mp_signed_bin_size(mp_int* a);
int
mp_read_signed_bin(mp_int* a, const unsigned char* b, int c);
int
...
int
mp_read_radix(mp_int* a, const char* str, int radix);
int
...
int
mp_fread(mp_int* a, int radix, FILE* stream);
int
mp_fwrite(mp_int* a, int radix, FILE* stream);
...
int
mp_exptmod_fast(mp_int* G, mp_int* X, mp_int* P, mp_int* Y, int mode);
int
s_mp_exptmod(mp_int* G, mp_int* X, mp_int* P, mp_int* Y, int mode);
void
