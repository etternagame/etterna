...
typedef struct
{
	...
	*/
	...
	/** ECC GF(p) point multiplication (from the NIST curves)
		...
		@param map Boolean indicated whether to map back to affine or not (can
	   be ignored if you work in affine only)
		@return CRYPT_OK on success
	*/
	int (
	  *ecc_ptmul)(void* k, ecc_point* G, ecc_point* R, void* modulus, int map);
	...
	*/
	 ...
	 */
	int (
	  *rsa_keygen)(prng_state* prng, int wprng, int size, long e, rsa_key* key);
...
int
ltc_init_multi(void** a, ...);
void
ltc_deinit_multi(void* a, ...);
