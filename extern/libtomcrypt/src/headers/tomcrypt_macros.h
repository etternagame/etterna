...
static inline __attribute__((always_inline)) unsigned
ROLc(unsigned word, const int i)
{
...
static inline __attribute__((always_inline)) unsigned
RORc(unsigned word, const int i)
{
...
ROL64(unsigned long word, int i)
{
...
static inline __attribute__((always_inline)) unsigned long
ROR64(unsigned long word, int i)
{
...
static inline __attribute__((always_inline)) unsigned long
ROL64c(unsigned long word, const int i)
{
...
static inline __attribute__((always_inline)) unsigned long
ROR64c(unsigned long word, const int i)
{
